...
export default function AboutPage() {
  const features = [
    ...
    },
    {
      ...
      description: "Advanced climate scenario modeling with financial impact projections to 2050.",
    },
  ]
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4" style={{ color: "#112A43" }}>
              About Climate Risk Analytics
            </h1>
            <p className="text-xl text-gray-600">
              Leading the future of climate-financial risk assessment for commercial real estate
            </p>
          </div>
          ...
          <Card className="rounded-2xl mb-12">
            ...
            <CardContent className="text-lg leading-relaxed text-gray-700">
              <p className="mb-4">
                Climate Risk Analytics empowers commercial real estate professionals with advanced tools to assess,
                understand, and mitigate climate-related financial risks. Our platform combines cutting-edge climate
                science with sophisticated financial modeling to provide actionable insights for individual assets and
                entire portfolios.
              </p>
              <p className="mb-4">
                As climate change accelerates and regulatory requirements evolve, property owners, investors, and
                lenders need comprehensive solutions to navigate the complex landscape of climate risk. Our platform
                bridges the gap between climate data and financial decision-making, enabling stakeholders to make
                informed choices that protect value and ensure long-term resilience.
              </p>
              <p>
                We believe that proactive climate risk management is not just an environmental imperative, but a
                financial necessity. Our mission is to democratize access to sophisticated climate risk analytics,
                making it possible for organizations of all sizes to build climate-resilient real estate portfolios.
              </p>
            </CardContent>
          </Card>
